...
if nome_aranha == 'Miles Morales' and frequencia_maquina < 800:
...
elif nome_aranha == 'Miles Morales' and 800 <= frequencia_maquina < 2400:
...
elif nome_aranha == 'Miranha-Furacão' and 0 < frequencia_maquina:
